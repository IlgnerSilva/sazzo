...
export function AuthLayout({
	...
	return (
		<div className="relative flex min-h-screen min-w-full max-w-full flex-col items-center justify-center bg-primary">
			<SwitcherLocale className="absolute top-4 right-4 bg-secondary" />
			<div className="flex min-h-screen w-full justify-center gap-16 md:p-16">
